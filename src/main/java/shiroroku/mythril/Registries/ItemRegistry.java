...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> mythril_axe = ITEMS_GEN_HANDHELD.register("mythril_axe", () -> new AxeItem(Mythril.MYTHRIL, 6.0F, -3.1F, defaultProp()));
    public static final RegistryObject<Item> mythril_hoe = ITEMS_GEN_HANDHELD.register("mythril_hoe", () -> new HoeItem(Mythril.MYTHRIL, -2, -1.0F, defaultProp()));
    public static final RegistryObject<Item> mythril_pickaxe = ITEMS_GEN_HANDHELD.register("mythril_pickaxe", () -> new PickaxeItem(Mythril.MYTHRIL, 1, -2.8F, defaultProp()));
    public static final RegistryObject<Item> mythril_shovel = ITEMS_GEN_HANDHELD.register("mythril_shovel", () -> new ShovelItem(Mythril.MYTHRIL, 1.5F, -3.0F, defaultProp()));
    public static final RegistryObject<Item> mythril_sword = ITEMS_GEN_HANDHELD.register("mythril_sword", () -> new SwordItem(Mythril.MYTHRIL, 3, -2.4F, defaultProp()));
